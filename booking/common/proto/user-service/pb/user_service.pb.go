...
var file_user_service_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x53, 0x75, 0x70, 0x65, 0x72, 0x48, 0x6f, 0x73, 0x74, 0x32, 0xcf, 0x06, 0x0a, 0x0b,
	...
	0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x3a, 0x05, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x5d, 0x0a,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x16, 0x22, 0x11, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x64, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x3a, 0x01, 0x2a, 0x12, 0x5b, 0x0a, 0x0a,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x14, 0x22, 0x0c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x75, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x3a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x81, 0x01, 0x0a, 0x14, 0x47, 0x65,
	0x74, 0x49, 0x66, 0x48, 0x6f, 0x73, 0x74, 0x49, 0x73, 0x53, 0x75, 0x70, 0x65, 0x72, 0x48, 0x6f,
	0x73, 0x74, 0x12, 0x21, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x66, 0x48,
	0x6f, 0x73, 0x74, 0x49, 0x73, 0x53, 0x75, 0x70, 0x65, 0x72, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65,
	...
	0x1c, 0x12, 0x1a, 0x2f, 0x67, 0x65, 0x74, 0x49, 0x66, 0x48, 0x6f, 0x73, 0x74, 0x49, 0x73, 0x53,
	0x75, 0x70, 0x65, 0x72, 0x68, 0x6f, 0x73, 0x74, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x0d, 0x5a,
	0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_user_service_proto_depIdxs = []int32{
	...
	17, // 2: user.UpdateUserRequest.user:type_name -> user.User
	17, // 3: user.UpdateUserResponse.user:type_name -> user.User
	16, // 4: user.CreateUserRequest.user:type_name -> user.NewUser
	17, // 5: user.CreateUserResponse.user:type_name -> user.User
	17, // 6: user.GetAllResponse.users:type_name -> user.User
	17, // 7: user.GetAllHostsResponse.users:type_name -> user.User
	15, // 8: user.NewUser.address:type_name -> user.AddressDTO
	15, // 9: user.User.address:type_name -> user.AddressDTO
	17, // 10: user.GetUserByIdResponse.user:type_name -> user.User
	...
	18, // 14: user.UserService.GetUserById:input_type -> user.GetUserByIdRequest
	9,  // 15: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	3,  // 16: user.UserService.Login:input_type -> user.LoginRequest
	5,  // 17: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	7,  // 18: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	20, // 19: user.UserService.GetIfHostIsSuperHost:input_type -> user.GetIfHostIsSuperHostRequest
	...
	19, // 23: user.UserService.GetUserById:output_type -> user.GetUserByIdResponse
	10, // 24: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	2,  // 25: user.UserService.Login:output_type -> user.LoginResponse
	6,  // 26: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	8,  // 27: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	21, // 28: user.UserService.GetIfHostIsSuperHost:output_type -> user.GetIfHostIsSuperHostResponse
