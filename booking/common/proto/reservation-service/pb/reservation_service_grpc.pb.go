...
type ReservationServiceClient interface {
	...
	GetActiveReservationsByGuestId(ctx context.Context, in *GetActiveReservationsGuestRequest, opts ...grpc.CallOption) (*GetActiveReservationsGuestResponse, error)
...
func (c *reservationServiceClient) GetActiveReservationsByGuestId(ctx context.Context, in *GetActiveReservationsGuestRequest, opts ...grpc.CallOption) (*GetActiveReservationsGuestResponse, error) {
	out := new(GetActiveReservationsGuestResponse)
...
type ReservationServiceServer interface {
	...
	GetActiveReservationsByGuestId(context.Context, *GetActiveReservationsGuestRequest) (*GetActiveReservationsGuestResponse, error)
...
func (UnimplementedReservationServiceServer) GetActiveReservationsByGuestId(context.Context, *GetActiveReservationsGuestRequest) (*GetActiveReservationsGuestResponse, error) {
...
func _ReservationService_GetActiveReservationsByGuestId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActiveReservationsGuestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReservationServiceServer).GetActiveReservationsByGuestId(ctx, req.(*GetActiveReservationsGuestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
