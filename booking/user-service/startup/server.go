...
func (server *Server) Start() {
	...
	userService := server.initUserService(userRepo, reservationEndpoint)
...
func (server *Server) initUserService(store model.UserStore, reservationClientAddress string) *service.UserService {
	return service.NewUserService(store, reservationClientAddress)
}
