...
func (server *Server) Start() {
	...
	reservationService := server.initReservationService(reservationRepo)
...
func (server *Server) initReservationService(store model.ReservationStore) *service.ReservationService {
